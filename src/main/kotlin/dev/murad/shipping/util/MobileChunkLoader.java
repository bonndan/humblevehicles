...
public class MobileChunkLoader {
    ...
    private static final TicketController ticketController = new TicketController(ResourceLocation.fromNamespaceAndPath(ShippingMod.MOD_ID, "mobile_chunks"));
    ...
    @SubscribeEvent
    public void register(RegisterTicketControllersEvent registerTicketControllersEvent) {
        registerTicketControllersEvent.register(ticketController);
    }

    private void setChunkLoad(boolean add, Pair<Integer, Integer> chunk) {

        ticketController.forceChunk((ServerLevel) entity.level(), entity, chunk.getFirst(), chunk.getSecond(), add, false);
    }
