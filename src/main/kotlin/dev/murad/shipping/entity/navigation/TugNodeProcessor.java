...
import static net.minecraft.world.level.pathfinder.PathType.BLOCKED;

public class TugNodeProcessor extends SwimNodeEvaluator {
    private final Level level;

    public TugNodeProcessor(Level level) {
        super(false);
        this.level = level;
    }
    ...
    @Override
    public @NotNull Target getTarget(double pX, double pY, double pZ) {
        return new Target(getNodeSimple(Mth.floor(pX), Mth.floor(pY), Mth.floor(pZ)));
    }
