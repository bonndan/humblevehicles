...
class EnergyTugModel<T>(root: ModelPart) : EntityModel<T>() where T : Entity, T : Colorable {
    ...
    companion object {
        ...
        val LAYER_LOCATION = ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(HumVeeMod.MOD_ID, "energy_tug_model"),
            "main"
        )
        ...
        fun createBodyLayer(): LayerDefinition {
            ...
            val bone: PartDefinition = partdefinition.addOrReplaceChild(
                "bone",
            ...
            val cube_r1: PartDefinition = bone.addOrReplaceChild(
                "cube_r1",
            ...
            val cube_r2: PartDefinition = bone.addOrReplaceChild(
                "cube_r2",
            ...
            val cube_r3: PartDefinition = bone.addOrReplaceChild(
                "cube_r3",
            ...
            val cube_r4: PartDefinition = bone.addOrReplaceChild(
                "cube_r4",
            ...
            val cube_r5: PartDefinition = bone.addOrReplaceChild(
                "cube_r5",
            ...
            val cube_r6: PartDefinition = bone.addOrReplaceChild(
                "cube_r6",
            ...
            val cube_r7: PartDefinition = bone.addOrReplaceChild(
                "cube_r7",
            ...
            val cube_r8: PartDefinition = bone.addOrReplaceChild(
                "cube_r8",
            ...
            val cube_r9: PartDefinition = bone.addOrReplaceChild(
                "cube_r9",
            ...
            val cube_r10: PartDefinition = bone.addOrReplaceChild(
                "cube_r10",
            ...
            val cube_r11: PartDefinition = bone.addOrReplaceChild(
                "cube_r11",
            ...
            val cube_r12: PartDefinition = bone.addOrReplaceChild(
                "cube_r12",
            ...
            val cube_r13: PartDefinition = bone.addOrReplaceChild(
                "cube_r13",
            ...
            val cube_r14: PartDefinition = bone.addOrReplaceChild(
                "cube_r14",
            ...
            val cube_r15: PartDefinition = bone.addOrReplaceChild(
                "cube_r15",
                CubeListBuilder.create().texOffs(154, 70).mirror()
            ...
            val cube_r16: PartDefinition = bone.addOrReplaceChild(
                "cube_r16",
            ...
            val cube_r17: PartDefinition = bone.addOrReplaceChild(
                "cube_r17",
                CubeListBuilder.create().texOffs(48, 126)
                    .addBox(-8.0f, -13.0f, -5.0f, 7.0f, 2.0f, 6.0f, CubeDeformation(0.0f)),
                PartPose.offsetAndRotation(9.4976f, -2.5f, -7.5478f, -0.8727f, 0.0f, 0.0f)
            )

            val cube_r18: PartDefinition = bone.addOrReplaceChild(
                "cube_r18",
            ...
            val cube_r19: PartDefinition = bone.addOrReplaceChild(
                "cube_r19",
                CubeListBuilder.create().texOffs(148, 24)
                    .addBox(-4.5f, 0.4f, -4.05f, 9.0f, 1.0f, 8.0f, CubeDeformation(0.0f))
                    .texOffs(0, 142).addBox(-2.85f, -8.6f, -3.15f, 6.0f, 14.0f, 6.0f, CubeDeformation(0.0f)),
                PartPose.offsetAndRotation(4.9976f, -6.19f, 17.8522f, -0.2618f, 0.0f, 0.0f)
            )

            val cube_r20: PartDefinition = bone.addOrReplaceChild(
                "cube_r20",
                CubeListBuilder.create().texOffs(154, 70)
            ...
            val cube_r21: PartDefinition = bone.addOrReplaceChild(
                "cube_r21",
            ...
            val cube_r22: PartDefinition = bone.addOrReplaceChild(
                "cube_r22",
            ...
            val cube_r23: PartDefinition = bone.addOrReplaceChild(
                "cube_r23",
            ...
            val cube_r24: PartDefinition = bone.addOrReplaceChild(
                "cube_r24",
            ...
            val cube_r25: PartDefinition = bone.addOrReplaceChild(
                "cube_r25",
            ...
            val cube_r26: PartDefinition = bone.addOrReplaceChild(
                "cube_r26",
            ...
            val cube_r27: PartDefinition = bone.addOrReplaceChild(
                "cube_r27",
            ...
            val cube_r28: PartDefinition = bone.addOrReplaceChild(
                "cube_r28",
            ...
            val cube_r29: PartDefinition = bone.addOrReplaceChild(
                "cube_r29",
            ...
            val cube_r30: PartDefinition = bone.addOrReplaceChild(
                "cube_r30",
            ...
            val cube_r31: PartDefinition = bone.addOrReplaceChild(
                "cube_r31",
            ...
            val cube_r32: PartDefinition = bone.addOrReplaceChild(
                "cube_r32",
            ...
            val cube_r33: PartDefinition = bone.addOrReplaceChild(
                "cube_r33",
            ...
            val cube_r34: PartDefinition = bone.addOrReplaceChild(
                "cube_r34",
            ...
            val cube_r35: PartDefinition = bone.addOrReplaceChild(
                "cube_r35",
            ...
            val cube_r36: PartDefinition = bone.addOrReplaceChild(
                "cube_r36",
            ...
            val cube_r37: PartDefinition = bone.addOrReplaceChild(
                "cube_r37",
            ...
            val cube_r38: PartDefinition = bone.addOrReplaceChild(
                "cube_r38",
            ...
            val cube_r39: PartDefinition = bone.addOrReplaceChild(
                "cube_r39",
            ...
            val cube_r40: PartDefinition = bone.addOrReplaceChild(
                "cube_r40",
