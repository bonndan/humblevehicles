...
public class SteamLocomotiveModel<T extends AbstractTrainCarEntity> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ShippingMod.MOD_ID, "steam_locomotive_model"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 46).addBox(-4.0F, -14.0F, -14.0F, 8.0F, 8.0F, 15.0F)
                ...
                .texOffs(0, 0).addBox(5.0F, -9.0F, -9.0F, 0.0F, 3.0F, 10.0F)
                .texOffs(0, 54).mirror().addBox(-5.0F, -5.0F, -6.0F, 2.0F, 4.0F, 3.0F).mirror(false), PartPose.offset(0.0F, 24.0F, 0.0F));

        PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 4.0F, 0.0F), PartPose.offsetAndRotation(0.0F, -5.0F, -13.0F, -0.7854F, 0.0F, 0.0F));
