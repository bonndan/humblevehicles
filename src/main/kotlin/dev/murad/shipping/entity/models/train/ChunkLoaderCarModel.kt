...
public class ChunkLoaderCarModel extends EntityModel<ChunkLoaderCarEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bb_main.addOrReplaceChild("ring", CubeListBuilder.create().texOffs(102, 0).addBox(-5.0F, -29.0F, -4.0F, 10.0F, 2.0F, 2.0F)
        ...
        bb_main.addOrReplaceChild("ring2", CubeListBuilder.create().texOffs(102, 0).addBox(-5.0F, -29.0F, -4.0F, 10.0F, 2.0F, 2.0F)
                .texOffs(100, 31).addBox(-5.0F, -29.0F, 4.0F, 10.0F, 2.0F, 2.0F)
                .texOffs(74, 41).addBox(3.0F, -29.0F, -2.0F, 2.0F, 2.0F, 6.0F)
                .texOffs(102, 4).addBox(-5.0F, -29.0F, -2.0F, 2.0F, 2.0F, 6.0F), PartPose.offset(0.0F, -3.0F, 0.0F));

        bb_main.addOrReplaceChild("ring3", CubeListBuilder.create().texOffs(102, 0).addBox(-5.0F, -29.0F, -4.0F, 10.0F, 2.0F, 2.0F)
                .texOffs(100, 31).addBox(-5.0F, -29.0F, 4.0F, 10.0F, 2.0F, 2.0F)
                .texOffs(74, 41).addBox(3.0F, -29.0F, -2.0F, 2.0F, 2.0F, 6.0F)
                .texOffs(102, 4).addBox(-5.0F, -29.0F, -2.0F, 2.0F, 2.0F, 6.0F), PartPose.offset(0.0F, -7.0F, 0.0F));

        partdefinition.addOrReplaceChild("bb_main2", CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -14.0F, -8.0F, 2.0F, 12.0F, 16.0F)
