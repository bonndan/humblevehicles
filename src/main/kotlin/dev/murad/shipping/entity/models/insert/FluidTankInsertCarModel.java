...
public class FluidTankInsertCarModel<T extends AbstractTrainCarEntity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bb_main.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(24, 32).addBox(-4.0F, 2.0F, -5.0F, 1.0F, 1.0F, 7.0F)
        ...
        bb_main.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(33, 32).addBox(-2.0F, 2.0F, -3.0F, 1.0F, 1.0F, 6.0F)
                .texOffs(33, 32).addBox(4.0F, 2.0F, -3.0F, 1.0F, 1.0F, 6.0F), PartPose.offsetAndRotation(0.0F, -42.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

        bb_main.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(40, 39).addBox(-3.0F, -4.0F, -39.0F, 6.0F, 5.0F, 0.0F)
